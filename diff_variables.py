...
print("\n" + ch*35 + "\n")
print("\tPrzypisanie wywołania funkcji do zmiennej\n")
drukuj = print
...
print("\n" + ch*35 + "\n")
print("\tUjawnienie adresów komórek pamięci przechowujących zmienne\n")
v10 = "abc"
print(v10, id(v10))
v11 = "abc"
print(v11, id(v11))
...
print("\n" + ch*35 + "\n")
print("\tPrzypisanie nowych wartości zmiennym w jednej linii kodu\n")
v7 = 6
v8 = 9
...
print("\n" + ch*35 + "\n")
print("\tTa sama wartość zdefiniowana w róznych systemach liczbowych\n")
int1 = 256          # dziesiętny
...
print("\n" + ch*35 + "\n")
print("\tPrezentacja liczby zmiennoprzecinkowej z uzyciem kropki diesiętnej i wykładnika\n")
re1 = 100.
re2 = 0.10
re3 = .10
re4 = 1e3
...
print("\n" + ch*35 + "\n")
print("\tMozna pobrać dane z klawiatury i przypisać je do zmiennej\n")
